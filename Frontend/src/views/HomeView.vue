      ...
      <div class="flex h-16 justify-between">
        ...
        <div class="hidden sm:ml-6 sm:flex sm:items-center">
          ...
          <Menu as="div" class="relative ml-3">
            <div>
              <MenuButton
                class="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-diveLogBlue focus:ring-offset-2"
              >
        ...
        <div class="flex items-center px-4">
          ...
          <div class="ml-3">
            <div class="text-base font-medium text-gray-800">
              {{ store.aktiverUser.vorname }} {{ store.aktiverUser.nachname }}
            </div>
            <div class="text-sm font-medium text-gray-500">{{ store.aktiverUser.email2 }}</div>
          </div>
        </div>
